...
class AdminGroupIO
{
	public static function home()
	{
		...
		$template = new Template("languages/en-gb/template/admin/group/list.html");
	...
	public static function create()
	{
		...
		{
			$template = new Template("languages/en-gb/template/admin/group/add.html");
	...
	public static function delete()
	{
		...
		if ($_GET[id])
		{
			...
			if ($_GET[sure] != "true")
			{
				$template = new Template("languages/en-gb/template/admin/group/delete.html");
	...
	public static function detail()
	{
		if ($_GET[id])
		{
			...
			$template = new Template("languages/en-gb/template/admin/group/detail.html");
	...
	public static function add_user()
	{
		...
		{			
			...
			if ($page_1_passed == false)
			{
				$template = new Template("languages/en-gb/template/admin/group/add_user.html");
	...
	public static function delete_user()
	{
		...
		if ($_GET[id] and $_GET[key])
		{
			if ($_GET[sure] != "true")
			{
				$template = new Template("languages/en-gb/template/admin/group/delete_user.html");
	...
	public static function add_organisation_unit()
	{
		...
		{		
			...
			if ($page_1_passed == false)
			{
				$template = new Template("languages/en-gb/template/admin/group/add_organisation_unit.html");
	...
	public static function delete_organisation_unit()
	{
		...
		if ($_GET[id] and $_GET[key])
		{
			if ($_GET[sure] != "true")
			{
				$template = new Template("languages/en-gb/template/admin/group/delete_organisation_unit.html");
	...
	public static function rename()
	{
		...
		if ($_GET[id])
		{
			...
			if ($page_1_passed == false)
			{
				$template = new Template("languages/en-gb/template/admin/group/rename.html");
