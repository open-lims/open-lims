...
class AdminSystemLogIO
{
	public static function home()
	{
		...
		$template = new Template("languages/en-gb/template/admin/system_log/list.html");
	...
	public static function detail()
	{
		if ($_GET[id])
		{
			if (SystemLog::exist_id($_GET[id]))
			{
				...
				$template = new Template("languages/en-gb/template/admin/system_log/detail.html");
	...
	public static function ip_info()
	{
		if ($_GET[id])
		{
			if (SystemLog::exist_ip($_GET[id]))
			{
				...
				$template = new Template("languages/en-gb/template/admin/system_log/ip_info.html");
