 ...
 */
	...
	$dialog[1][display_name]	= "Equipment Categories";
	...
	$dialog[2][display_name]	= "Equipment Types";
	...
	$dialog[3][display_name]	= "List OU Equipment";
	...
	$dialog[4][display_name]	= "Equipment Item Reportt";
	$dialog[4][weight]			= 500;
	...
	$dialog[5][display_name]	= "Equipment";
	$dialog[5][weight]			= 200;
?>