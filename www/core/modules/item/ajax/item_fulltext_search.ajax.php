...
/**
 * Item Fulltext Search Ajax IO Class
 * @package item
 */
class ItemFulltextSearchAjax
{
	/**
	 ...
	 * @throws BaseAjaxArgumentMissingException
	 */
	public static function count_items($json_argument_array)
	{
		$argument_array = json_decode($json_argument_array);
		...
		if (is_array($argument_array))
		{
			...
			return Item_Wrapper::count_fulltext_search($string, $item_type_array, $language_id);
		}
		else
		{
			throw new BaseAjaxArgumentMissingException();
