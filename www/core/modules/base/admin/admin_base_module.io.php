...
class AdminBaseModuleIO
{
	...
	{
		$list = new ListStat_IO(SystemFE_Wrapper::count_base_module(), 20);
		...
		if ($_GET[page])
		{
			...
			{
				$result_array = SystemFE_Wrapper::list_base_module($_GET[sortvalue], $_GET[sortmethod], ($_GET[page]*20)-20, ($_GET[page]*20));
			}
			else
			{
				$result_array = SystemFE_Wrapper::list_base_module(null, null, ($_GET[page]*20)-20, ($_GET[page]*20));
			}				
		}
		else
		{
			if ($_GET[sortvalue] and $_GET[sortmethod])
			{
				$result_array = SystemFE_Wrapper::list_base_module($_GET[sortvalue], $_GET[sortmethod], 0, 20);
			}
			else
			{
				$result_array = SystemFE_Wrapper::list_base_module(null, null, 0, 20);
			}	
		}
