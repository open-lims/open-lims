...
class AdminBaseNavigationIO
{
	...
	{
		$list = new ListStat_IO((SystemFE_Wrapper::count_base_module_navigation()+1), 20);
		...
		if ($_GET[page])
		{
			$result_array = SystemFE_Wrapper::list_base_module_navigation(($_GET[page]*20)-20, ($_GET[page]*20));			
		}
		else
		{
			$result_array = SystemFE_Wrapper::list_base_module_navigation(0, 20);		
		}
