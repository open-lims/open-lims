		...
		if ($session->is_valid())
		{
			switch($_GET[run]):
				...
				case "list_project_permissions":
					echo $this->list_project_permissions($_POST[row_array], $_POST[argument_array], $_POST[css_page_id],  $_POST[css_row_sort_id], $_POST[entries_per_page], $_GET[page], $_GET[sortvalue], $_GET[sortmethod]);
				break;
