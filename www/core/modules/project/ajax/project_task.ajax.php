...
class ProjectTaskAjax extends Ajax
{
	...
	private function list_project_tasks($json_row_array, $json_argument_array, $css_page_id, $css_row_sort_id, $entries_per_page, $page, $sortvalue, $sortmethod)
	{
		...
		if ($session->is_valid())
		{
			switch($_GET[run]):
				...
				case "list_project_tasks":
					echo $this->list_project_tasks($_POST[row_array], $_POST[argument_array], $_POST[css_page_id],  $_POST[css_row_sort_id], $_POST[entries_per_page], $_GET[page], $_GET[sortvalue], $_GET[sortmethod]);
				break;
