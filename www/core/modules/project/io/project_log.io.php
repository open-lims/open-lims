	...
	public static function list_project_related_logs()
	{
		...
		if ($_GET[project_id])
		{
			if ($project_security->is_access(1, false) == true)
			{
				...
				$template = new Template("template/project/project_log.html");
		...
		if ($_GET[project_id])
		{
			...
			{	
				...
				if ($project_security->is_access(1, false) == true)
				{
					...
					$template = new Template("template/project/project_log_detail.html");
	...
	public static function add_comment()
	{
		...
		if ($_GET[project_id])
		{
			if ($project_security->is_access(3, false) == true)
			{
				...
				if ($no_error == false)
				{
					$template = new Template("template/project/project_log_add.html");
