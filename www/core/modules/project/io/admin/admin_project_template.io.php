...
class AdminProjectTemplateIO
{
	public static function home()
	{
		...
		$template = new Template("template/project/admin/project_template/list.html");	
	...
	public static function create()
	{
		...
		{
			$template = new Template("template/project/admin/project_template/add.html");
	...
	public static function delete()
	{
		if ($_GET[id])
		{
			if ($_GET[sure] != "true")
			{
				$template = new Template("template/project/admin/project_template/delete.html");
