	...
	private function get_content($page)
	{
		...
		switch ($page):		
			case "1":
				...
				$template = new Template("../../../../template/sample/new_sample_page_1.html");	
			...
			case "2":
				...
				$template = new Template("../../../../template/sample/new_sample_page_2.html");	
			...
			case "3":
				...
				$template = new Template("../../../../template/sample/new_sample_page_3.html");
			...
			case "4":
				...
				if (is_array($required_array) and count($required_array) >= 1)
				{
					...
					if ($is_value == true xor $is_sample == true)
					{
						if ($is_value == true)
						{
							$template = new Template("../../../../template/sample/new_sample_page_4_value.html");
						...
						{
							$template = new Template("../../../../template/sample/new_sample_page_4_sample.html");
					...
					{
						$template = new Template("../../../../template/sample/new_sample_page_4_error.html");
						return $template->get_string();
					}
				}
				else
			...
			case "5":
				...
				$template = new Template("../../../../template/sample/new_sample_page_5.html");
