...
/**
 * Sample Template Category Admin Ajax IO Class
 * @package sample
 */
class AdminSampleTemplateCatAjax
{
	public static function list_categories($json_column_array, $json_argument_array, $get_array, $css_page_id, $css_row_sort_id, $entries_per_page, $page, $sortvalue, $sortmethod)
	{
		...
		if ($user->is_admin())
		{
			...
			$list_array = Sample_Wrapper::list_sample_template_categories($sortvalue, $sortmethod, ($page*$entries_per_page)-$entries_per_page, ($page*$entries_per_page));
