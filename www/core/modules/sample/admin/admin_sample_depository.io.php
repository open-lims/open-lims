...
class AdminSampleDepositoryIO
{
	...
	{
		$template = new Template("template/samples/admin/sample_depository/list.html");	
	...
	{		
		if (($_GET[action] == "add_child" and $_GET[id]) or $_GET[action] == "add")
		{
			...
			{
				$template = new Template("template/samples/admin/sample_depository/add.html");
	...
	public static function delete()
	{
		if ($_GET[id])
		{
			if ($_GET[sure] != "true")
			{
				$template = new Template("template/samples/admin/sample_depository/delete.html");
	...
	public static function edit()
	{
		if ($_GET[id])
		{
			...
			if ($page_1_passed == false)
			{
				$template = new Template("template/samples/admin/sample_depository/edit.html");
