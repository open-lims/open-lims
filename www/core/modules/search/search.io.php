...
class SearchIO
{
	 ...
	 * @todo use SQL Join for permission check
	 */
	private static function sample_search()
	{
		global $user, $session;
		...
		if ($no_error == false)
		{
			$template = new Template("languages/en-gb/template/search/sample_search.html");
		...
		else
		{
			...
			$template = new Template("languages/en-gb/template/search/sample_search_result.html");
