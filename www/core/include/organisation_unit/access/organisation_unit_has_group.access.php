...
class OrganisationUnitHasGroup_Access
{
	...
	function __construct($primary_key)
	{
		...
		{
			$sql = "SELECT * FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE primary_key = ".$primary_key."";
			$res = $db->db_query($sql);
	...
	public function create($organisation_unit_id, $group_id)
	{
		...
		{
			$sql_write = "INSERT INTO ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." (primary_key,organisation_unit_id,group_id) " .
					"VALUES (nextval('".self::ORGANISATION_UNIT_HAS_GROUP_PK_SEQUENCE."'::regclass),".$organisation_unit_id.",".$group_id.")";
			$res_write = $db->db_query($sql_write);
			
			if ($db->db_affected_rows($res_write) == 1)
			{
				$sql_read = "SELECT primary_key FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE primary_key = currval('".self::ORGANISATION_UNIT_HAS_GROUP_PK_SEQUENCE."'::regclass)";
	...
	public function delete()
	{
		...
		if ($this->primary_key)
		{
			...
			$sql = "DELETE FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE primary_key = ".$tmp_primary_key."";
			$res = $db->db_query($sql);
	...
	public function set_organisation_unit_id($organisation_unit_id)
	{
		...
		{
			$sql = "UPDATE ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." SET organisation_unit_id = '".$organisation_unit_id."' WHERE primary_key = '".$this->primary_key."'";
			$res = $db->db_query($sql);
	...
	public function set_group_id($group_id)
	{
		...
		{
			$sql = "UPDATE ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." SET group_id = '".$group_id."' WHERE primary_key = '".$this->primary_key."'";
			$res = $db->db_query($sql);
	...
	{	
		...
		if (is_numeric($group_id))
		{
			...
			$sql = "SELECT COUNT(organisation_unit_id) AS result FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE group_id = ".$group_id."";
			$res = $db->db_query($sql);
			$data = $db->db_fetch_assoc($res);
	...
	{	
		...
		if (is_numeric($organisation_unit_id))
		{
			...
			$sql = "SELECT COUNT(group_id) AS result FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE organisation_unit_id = ".$organisation_unit_id."";
			$res = $db->db_query($sql);
			$data = $db->db_fetch_assoc($res);
	...
	public static function get_pk_by_group_id_and_organisation_unit_id($group_id, $organisation_unit_id)
	{
		...
		if (is_numeric($group_id) and is_numeric($organisation_unit_id))
		{
			...
			$sql = "SELECT primary_key FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE group_id = ".$group_id." AND organisation_unit_id = ".$organisation_unit_id."";
			$res = $db->db_query($sql);
			$data = $db->db_fetch_assoc($res);
	...
	public static function list_organisation_units_by_group_id($group_id)
	{
		...
		if (is_numeric($group_id))
		{
			...
			$sql = "SELECT organisation_unit_id FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE group_id = ".$group_id."";
			$res = $db->db_query($sql);
	...
	public static function list_groups_by_organisation_unit_id($organisation_unit_id)
	{
		...
		if (is_numeric($organisation_unit_id))
		{
			...
			$sql = "SELECT group_id FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE organisation_unit_id = ".$organisation_unit_id."";
			$res = $db->db_query($sql);
	...
	public static function delete_by_group_id($group_id)
	{
		...
		if (is_numeric($group_id))
		{
			...
			$sql = "DELETE FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE group_id = ".$group_id."";
			$res = $db->db_query($sql);
			$data = $db->db_fetch_assoc($res);
	...
	public static function delete_by_organisation_unit_id($organisation_unit_id)
	{
		...
		if (is_numeric($organisation_unit_id))
		{
			...
			$sql = "DELETE FROM ".self::ORGANISATION_UNIT_HAS_GROUP_TABLE." WHERE organisation_unit_id = ".$organisation_unit_id."";
			$res = $db->db_query($sql);
			$data = $db->db_fetch_assoc($res);
