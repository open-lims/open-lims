...
class SampleHasOrganisationUnit_Access
{
	...
	function __construct($primary_key)
	{
		...
		{
			$sql = "SELECT * FROM ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." WHERE primary_key='".$primary_key."'";
			$res = $db->db_query($sql);			
	...
	public function create($sample_id, $organisation_unit_id)
	{
		...
		{
			$sql_write = "INSERT INTO ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." (primary_key,sample_id,organisation_unit_id) " .
					"VALUES (nextval('".self::SAMPLE_HAS_ORGANISATION_UNIT_PK_SEQUENCE."'::regclass),".$sample_id.",".$organisation_unit_id.")";
			$res_write = $db->db_query($sql_write);
			
			if ($db->db_affected_rows($res_write) == 1)
			{
				$sql_read = "SELECT primary_key FROM ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." WHERE primary_key = currval('".self::SAMPLE_HAS_ORGANISATION_UNIT_PK_SEQUENCE."'::regclass)";
	...
	public function delete()
	{
		...
		if ($this->primary_key)
		{
			...
			$sql = "DELETE FROM ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." WHERE primary_key = ".$tmp_primary_key."";
			$res = $db->db_query($sql);
	...
	public function set_sample_id($sample_id)
	{
		...
		{
			$sql = "UPDATE ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." SET sample_id = '".$sample_id."' WHERE primary_key = '".$this->primary_key."'";
			$res = $db->db_query($sql);
	...
	public function set_organisation_unit_id($organisation_unit_id)
	{
		...
		{
			$sql = "UPDATE ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." SET organisation_unit_id = '".$organisation_unit_id."' WHERE primary_key = '".$this->primary_key."'";
			$res = $db->db_query($sql);
	...
	public static function get_entry_by_sample_id_and_organisation_unit_id($sample_id, $organisation_unit_id)
	{
		...
		if (is_numeric($sample_id) and is_numeric($organisation_unit_id))
		{
			...
			$sql = "SELECT primary_key FROM ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." WHERE sample_id = ".$sample_id." AND organisation_unit_id = ".$organisation_unit_id."";
			$res = $db->db_query($sql);
			$data = $db->db_fetch_assoc($res);
	...
	public static function list_entries_by_sample_id($sample_id)
	{
		...
		if (is_numeric($sample_id))
		{
			...
			$sql = "SELECT primary_key FROM ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." WHERE sample_id = ".$sample_id."";
			$res = $db->db_query($sql);
	...
	public static function list_entries_by_organisation_unit_id($organisation_unit_id)
	{
		...
		if (is_numeric($organisation_unit_id))
		{
			...
			$sql = "SELECT primary_key FROM ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." WHERE organisation_unit_id = ".$organisation_unit_id."";
			$res = $db->db_query($sql);
	...
	public static function list_entries()
	{
		...
		$sql = "SELECT primary_key FROM ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE."";
		$res = $db->db_query($sql);
	...
	public static function delete_by_organisation_unit_id($organisation_unit_id)
	{
		...
		if (is_numeric($organisation_unit_id))
		{
			$sql = "DELETE FROM ".self::SAMPLE_HAS_ORGANISATION_UNIT_TABLE." WHERE organisation_unit_id = ".$organisation_unit_id."";
			$res = $db->db_query($sql);
