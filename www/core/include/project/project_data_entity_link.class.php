...
/**
 * Project Data Entity Link Class
 * Listens on Data Entity link events while adding a file as a sub-item
 * @package project
 */
class ProjectDataEntityLink implements EventListenerInterface
{
	/**
    ...
    public static function listen_events($event_object)
    {
   		if ($event_object instanceof DataEntityLinkEvent)
    	{
    		...
    		if($get_array['nav'] == "project" and is_numeric($get_array['project_id']) and $get_array['parent'] and is_numeric($get_array['parent_id']))
    		{
