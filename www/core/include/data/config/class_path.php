 ...
 */
	...
	$classes['ParameterTemplateCreateFieldCreateFailedException']		= $path_prefix."core/include/data/parameter/exceptions/parameter_template_create_field_create_failed.exception.class.php";
	$classes['ParameterTemplateCreateFieldLimitCreateFailedException']	= $path_prefix."core/include/data/parameter/exceptions/parameter_template_create_field_limit_create_failed.exception.class.php";
	$classes['ParameterTemplateCreateFieldLinkFailedException']			= $path_prefix."core/include/data/parameter/exceptions/parameter_template_create_field_link_failed.exception.class.php";
	$classes['ParameterTemplateCreateIDMissingException']				= $path_prefix."core/include/data/parameter/exceptions/parameter_template_create_id_missing.exception.class.php";
	$classes['ParameterTemplateCreateLimitCreateFailedException']		= $path_prefix."core/include/data/parameter/exceptions/parameter_template_create_limit_create_failed.exception.class.php";
	$classes['ParameterTemplateDeleteException']						= $path_prefix."core/include/data/parameter/exceptions/parameter_template_delete.exception.class.php";
	$classes['ParameterTemplateDeleteFailedException']					= $path_prefix."core/include/data/parameter/exceptions/parameter_template_delete_failed.exception.class.php";
	$classes['ParameterTemplateDeleteFieldDeleteFailedException']		= $path_prefix."core/include/data/parameter/exceptions/parameter_template_delete_field_delete_failed.exception.class.php";
	$classes['ParameterTemplateDeleteFieldLimitDeleteFailedException']	= $path_prefix."core/include/data/parameter/exceptions/parameter_template_delete_field_limit_delete_failed.exception.class.php";
	$classes['ParameterTemplateDeleteFieldLinkFailedException']			= $path_prefix."core/include/data/parameter/exceptions/parameter_template_delete_field_link_failed.exception.class.php";
	$classes['ParameterTemplateDeleteFieldMethodFailedException']		= $path_prefix."core/include/data/parameter/exceptions/parameter_template_delete_field_method_failed.exception.class.php";
	$classes['ParameterTemplateDeleteIDMissingException']				= $path_prefix."core/include/data/parameter/exceptions/parameter_template_delete_id_missing.exception.class.php";
	$classes['ParameterTemplateDeleteLimitDeleteFailedException']		= $path_prefix."core/include/data/parameter/exceptions/parameter_template_delete_limit_delete_failed.exception.class.php";
