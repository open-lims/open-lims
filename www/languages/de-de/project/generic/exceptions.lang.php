...
$LANG_EXCEPTION['ProjectSetNextStatusException'] 									= "N�chster Projekt-Status konnte nicht gesetzt werden!";
...
$LANG_EXCEPTION['ProjectCreatePermissionUserException'] 							= "Eigent�mer-Recht konnten nicht erstellt werden!";
...
$LANG_EXCEPTION['ProjectCreatePermissionQualityManagerException'] 					= "Qualit�ts-Manager-Rechte konnten nicht erstellt werden!";

$LANG_EXCEPTION['ProjectDeleteException'] 											= "Projekt konnte nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectDeleteContainsSubProjectsException'] 						= "L�schen fehlgeschlagen - Projekt enth�lt noch Unterprojekte!";
$LANG_EXCEPTION['ProjectDeleteFolderException'] 									= "Projekt-Ordner konnte nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectDeleteItemException'] 										= "Projekt-'Items' konnten nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectDeleteLinkException'] 										= "Projekt-Links konnten nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectDeleteLogException'] 										= "Projekt-Log konnte nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectDeletePermissionException'] 								= "Projekt-Rechte konnten nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectDeleteStatusException'] 									= "Projekt-Status konnte(n) nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectDeleteTaskException'] 										= "Projekt-Aufgaben konnten nicht gel�scht werden!";
...
$LANG_EXCEPTION['ProjectItemUnlinkException'] 										= "'Item' konnte nicht vom Projekt gel��t werden!";
...
$LANG_EXCEPTION['ProjectLogDeleteException'] 										= "Das Projekt-Log konnte nicht gel�scht werden!";
...
$LANG_EXCEPTION['ProjectPermissionUserDeleteException'] 							= "Nutzerberechtigung konnte nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectPermissionUserDeleteVirtualFolderException'] 				= "Der virtuelle Ordner konnte nicht gel�sct werden!";
...
$LANG_EXCEPTION['ProjectPermissionOrganisationUnitDeleteException'] 				= "Organisationseinheitenberechtigung konnte nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectPermissionOrganisationUnitDeleteVirtualFolderException'] 	= "Der virtuelle Ordner konnte nicht gel�sct werden!";
...
$LANG_EXCEPTION['ProjectPermissionGroupDeleteException'] 							= "Gruppenberechtigugn konnte nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectPermissionGroupDeleteVirtualFolderException'] 				= "Der virtuelle Ordner konnte nicht gel�sct werden!";
...
$LANG_EXCEPTION['ProjectSecurityChangeException'] 									= "Projekt Sicherheits�nderung fehlgeschlagen!";
...
$LANG_EXCEPTION['ProjectStatusDeleteException'] 									= "Der Projekt-Status konnte nicht gel�scht werden!";
...
$LANG_EXCEPTION['ProjectTaskDeleteException'] 										= "Die Projektaufgabe konnte nicht gel�scht werden!";
...
$LANG_EXCEPTION['ProjectTemplateDeleteException'] 									= "Das Projekt-Template konnte nicht gel�scht werden!";
$LANG_EXCEPTION['ProjectTemplateDeleteInUseException'] 								= "Das Projekt-Template ist noch in verwendung!";
$LANG_EXCEPTION['ProjectTemplateDeleteOLDLDeleteException'] 						= "Der OLDL Eintrag konnte nicht gel�scht werden!";
...
$LANG_EXCEPTION['ProjectTemplateCategoryDeleteException'] 							= "Die Projekt-Template-Kategorie konnte nicht gel�scht werden!";
